    ...
    checklist: [
      {
        id: 'ai-1',
        title: 'AI 도구 비교 검토',
        description: 'Claude, Cursor, Bolt 중 적합한 도구 선택',
        checked: false,
      },
      {
        id: 'ai-2',
        title: '선택한 도구 설치/가입',
        description: '선택한 AI 도구에 가입하거나 설치하세요',
        checked: false,
      },
      {
        id: 'ai-3',
        title: '문서 전달 방법 숙지',
        description: 'AI에게 문서를 효과적으로 전달하는 방법을 익히세요',
        checked: false,
      },
      {
        id: 'ai-4',
        title: '첫 번째 테스트 대화',
        description: 'AI와 첫 대화를 시도해보세요',
        checked: false,
      },
    ],
  },
...
export const AI_TOOLS_COMPARISON = [
  {
    ...
    name: 'Claude',
    url: 'https://claude.ai',
    bestFor: '문서 분석, 복잡한 로직 설명, 디버깅',
    pros: ['맥락 이해력 뛰어남', '긴 코드 분석 가능', '친절한 설명'],
    cons: ['실시간 코드 실행 불가', '직접 파일 편집 불가'],
    difficulty: 'easy',
    recommended: true,
  },
  {
    ...
    name: 'Cursor',
    url: 'https://cursor.sh',
    bestFor: 'IDE 통합 개발, 실시간 코드 작성',
    pros: ['IDE 내장', '코드 자동완성', '프로젝트 전체 이해'],
    cons: ['유료 플랜 권장', '설치 필요'],
    difficulty: 'medium',
    recommended: false,
  },
  {
    ...
    name: 'Bolt.new',
    url: 'https://bolt.new',
    bestFor: '빠른 프로토타입, 웹앱 즉시 생성',
    pros: ['즉시 실행', '설치 불필요', '실시간 미리보기'],
    cons: ['복잡한 앱에 한계', '세밀한 제어 어려움'],
    difficulty: 'easy',
    recommended: false,
  },
];
